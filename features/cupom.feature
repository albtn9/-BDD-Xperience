#language: pt
    ...
    Funcionalidade:  Uso de Cupons no Checkout
        ...
        Contexto:
         Dado que inicie a compra do item:
         | name     |  Café com Leite  | 
         | price    |  R$ 19,99        |
         | delivery |  R$ 10,00        |
         | total    |  R$ 29,99        |
        ...
        #     E o item que está no meu carrinho é o Café com Leite de R$ 19,99
        #     E que a taxa de entrega é de R$ 10,00
        #     E o valor total é de R$ 29,99
        #     E que tenho um cupom com 20% de desconto "MEUCAFE"
        ...
        #     E que a taxa de entrega é de R$ 10,00
        #     E o valor total é de R$ 29,99
        #     E tenho um cupom que está Invalido "PROMO100"
        # Quando aplico esse cupom de desconto
        # Então devo ver a seguinte notificação "Cupom inválido!"
        #     E o valor final deve permanecer o mesmo
